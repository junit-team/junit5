...
public class JavaTestDescriptorTestCase {
  ...
  private static final String TEST_METHOD_ID =
      "org.junit.engine.support.JavaTestDescriptorTestCase#test()";
  private static final String TEST_METHOD_UID = JUNIT_5_ENGINE_ID + ":" + TEST_METHOD_ID;

  private static final String TEST_METHOD_STRING_BIGDECIMAL_ID =
      "org.junit.engine.support.JavaTestDescriptorTestCase#test(java.lang.String, java.math.BigDecimal)";
  private static final String TEST_METHOD_STRING_BIGDECIMAL_UID =
      JUNIT_5_ENGINE_ID + ":" + TEST_METHOD_STRING_BIGDECIMAL_ID;
  ...
  private static void constructor() throws Exception {
    ...
    JavaTestDescriptor descriptor =
        new JavaTestDescriptor(JUNIT_5_ENGINE_ID, testClass, testMethod);
  ...
  private static void from() throws Exception {
    ...
    assertEqual(JavaTestDescriptorTestCase.class.getDeclaredMethod("test"),
    ...
    assertEqual(JavaTestDescriptorTestCase.class, descriptor.getTestClass());
    assertEqual(
        JavaTestDescriptorTestCase.class.getDeclaredMethod("test", String.class, BigDecimal.class),
        descriptor.getTestMethod());
  }
