...
class DiscoverySelectorsTests {
	...
	class SelectClasspathResourceTests {
		...
		void selectClasspathResourcesPreconditions() {
			...
			assertViolatesPrecondition(() -> selectClasspathResources(Collections.emptySet()));
			assertViolatesPrecondition(() -> selectClasspathResources(Collections.singleton(null)));
			assertViolatesPrecondition(() -> selectClasspathResources(Set.of(new StubResource(null))));
			assertViolatesPrecondition(() -> selectClasspathResources(Set.of(new StubResource(""))));
			assertViolatesPrecondition(
				() -> selectClasspathResources(Set.of(new StubResource("a"), new StubResource("b"))));
		}
