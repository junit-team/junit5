...
class DefaultConversionServiceTests {
	...
	private boolean canConvert(Object input, Class<?> targetClass, ClassLoader classLoader) {
		return DefaultConversionService.INSTANCE.canConvert(input, targetClass, classLoader);
	}

	private Object convert(Object input, Class<?> targetClass, ClassLoader classLoader) {
		return DefaultConversionService.INSTANCE.convert(input, targetClass, classLoader);
	}

	private static ClassLoader classLoader() {
		Method declaringExecutable = ReflectionSupport.findMethod(DefaultConversionServiceTests.class, "foo").get();
