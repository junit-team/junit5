...
/**
 * Default behaviour when handling exceptions in test methods is to rethrow them.
 */
public class DefaultExceptionHandler implements ExceptionHandlerExtensionPoint {
