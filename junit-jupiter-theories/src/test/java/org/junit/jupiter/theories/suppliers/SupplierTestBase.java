...
public abstract class SupplierTestBase<T extends TheoryArgumentSupplier, U extends Annotation, V> {
    ...
    public SupplierTestBase(Class<T> argumentSupplierClassUnderTest, Class<U> parameterSupplierAnnotationClass, Class<V> typeProducedBySupplier) {
    ...
    public void testAnnotationProperlyConfigured() {
        //Test
        Optional<ArgumentsSuppliedBy> retrievedAnnotation = AnnotationSupport.findAnnotation(parameterSupplierAnnotationClass, ArgumentsSuppliedBy.class);
