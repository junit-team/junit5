...
NOTE: Registered extensions are inherited within test class hierarchies.
...
class, test method, or custom _<<writing-tests-meta-annotations,composed annotation>>_ with
