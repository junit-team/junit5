...
* The `ConsoleLauncher` no longer supports passing package, class, or method names as non-option
  arguments. Please use the new explicit selector options instead.
