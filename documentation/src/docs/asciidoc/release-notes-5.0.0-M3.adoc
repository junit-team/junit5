...
* `PackageSelector` has been renamed to `JavaPackageSelector` to align with `JavaPackageSource`.
* `ClassSelector` has been renamed to `JavaClassSelector` to align with `JavaClassSource`.
* `MethodSelector` has been renamed to `JavaMethodSelector` to align with `JavaMethodSource`.
