...
* New implicit conversions from strings to arguments of type `java.io.File`,
  `java.math.BigDecimal`, `java.math.BigInteger`, `java.net.URI`, `java.net.URL`,
  `java.util.Currency`, `java.util.Locale`, `java.util.UUID`, and `java.nio.file.Path` in
  parameterized tests.
