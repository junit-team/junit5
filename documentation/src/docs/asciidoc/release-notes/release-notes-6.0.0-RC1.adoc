...
* Improved validation of additional classpath roots in the Console Launcher.
Now logs and skips only non-existent entries, ensuring more consistent behavior.
