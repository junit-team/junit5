...
link:{junit5-repo}+/milestone/89?closed=1+[5.12.0] milestone page in the JUnit repository
on GitHub.
...
[[release-notes-5.12.0-junit-platform-bug-fixes]]
==== Bug Fixes
...
[[release-notes-5.12.0-junit-vintage-bug-fixes]]
==== Bug Fixes

* ❓

[[release-notes-5.12.0-junit-vintage-deprecations-and-breaking-changes]]
==== Deprecations and Breaking Changes
