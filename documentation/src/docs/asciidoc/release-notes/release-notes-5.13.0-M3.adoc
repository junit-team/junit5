...
* Introduce resource management mechanism that allows preparing and sharing state within
  an execution or among test engines via stores that are scoped to a `LauncherSession` or
