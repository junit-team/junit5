...
* New `junit.jupiter.params.arguments.conversion.locale.format` configuration parameter to select the format used for the conversion of `@ParameterizedTest` `Locale` arguments.
See the
