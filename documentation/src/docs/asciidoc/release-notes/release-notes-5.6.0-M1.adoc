...
* New `TestInstancePreDestroyCallback` interface that defines the API for `Extension`'s that wish
  to process test instances *after* they have been used in tests and *before* they are destroyed.
