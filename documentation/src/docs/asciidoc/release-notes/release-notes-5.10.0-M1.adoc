...
* The existing functionality of the Console Launcher has been split into two subcommands:
  `execute` for executing tests and `engines` for listing registered test engines.
* A new `discover` subcommand has been added to the Console Launcher to print the
