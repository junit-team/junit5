...
This document contains the _change log_ for all JUnit 5 releases since 5.3 GA.
...
include::release-notes-5.4.0-RC2.adoc[]

include::release-notes-5.4.0-RC1.adoc[]

include::release-notes-5.4.0-M1.adoc[]
