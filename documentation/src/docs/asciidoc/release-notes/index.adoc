...
This document contains the _change log_ for all JUnit 5 releases since 5.7 GA.
...
include::{basedir}/release-notes-5.7.2.adoc[]

include::{basedir}/release-notes-5.7.1.adoc[]
