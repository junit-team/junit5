...
// Jupiter Support and Built-in Extensions
:TempDirectory:                          {javadoc-root}/org/junit/jupiter/api/support/io/TempDirectory.html[TempDirectory]
// Jupiter Conditions
...
// Jupiter I/O
:TempDir:                                {javadoc-root}/org/junit/jupiter/api/io/TempDir.html[@TempDir]
// Jupiter Params
...
:Truth:                                  https://google.github.io/truth/[Truth]
