...
The following example demonstrates how to declare a test named `myRepeatedTest()` that
...
the display names for individual repetitions of the previous `myRepeatedTest()` example
would be: `myRepeatedTest() :: repetition 1 of 10`, `myRepeatedTest() :: repetition 2 of
10`, etc.
