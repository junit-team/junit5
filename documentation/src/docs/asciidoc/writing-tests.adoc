...
interface default methods. `@BeforeAll` and `@AfterAll` can be declared on static methods of the
test interface while `@ExtendWith` and `@Tag` can be declared on the test interface to configure
...
`@ExtendWidth` and `@Tag` can be declared on the test interface so that classes that implement it
...
----
:junitPlatformTest
18:28:13.967 [main] INFO  org.junit5.issue281.TestConsoleLogger - beforeAllTests
18:28:13.982 [main] INFO  org.junit5.issue281.TestConsoleLogger - About to execute [dynamicTestsFromCollection]
18:28:14.000 [main] INFO  org.junit5.issue281.TimingExtension - Method [dynamicTestsFromCollection] took 13 ms.
18:28:14.004 [main] INFO  org.junit5.issue281.TestConsoleLogger - Finished executing [dynamicTestsFromCollection]
18:28:14.007 [main] INFO  org.junit5.issue281.TestConsoleLogger - About to execute [isEqualValue]
18:28:14.008 [main] INFO  org.junit5.issue281.TimingExtension - Method [isEqualValue] took 1 ms.
18:28:14.009 [main] INFO  org.junit5.issue281.TestConsoleLogger - Finished executing [isEqualValue]
18:28:14.011 [main] INFO  org.junit5.issue281.TestConsoleLogger - afterAllTests
