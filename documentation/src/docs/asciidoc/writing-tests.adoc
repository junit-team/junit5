...
pattern: `"{displayName} :: repetition {currentRepetition} of {totalRepetitions}"`. Thus,
the display names for individual repetitions of the previous `repeatedTest()` example
would be: `repeatedTest() :: repetition 1 of 10`, `repeatedTest() :: repetition 2 of 10`,
etc.
...
The `repeatedTest()` method is identical to example from the previous section.
...
The next method, `repeatedTestWithCustomDisplayName()` combines a custom display name
with a custom display name pattern and then uses `TestInfo` to verify the format of the
generated display name. `Repeat!` is the `{displayName}` which comes from the
`@DisplayName` declaration, and `1/1` comes from `{currentRepetition}/{totalRepetitions}`.
...
INFO - About to execute repetition 1 of 1 for repeatedTestWithCustomDisplayName
...
│  │  ├─ repeatedTest() :: repetition 3 of 10 ✔
│  │  ├─ repeatedTest() :: repetition 4 of 10 ✔
│  │  ├─ repeatedTest() :: repetition 5 of 10 ✔
│  │  ├─ repeatedTest() :: repetition 6 of 10 ✔
│  │  ├─ repeatedTest() :: repetition 7 of 10 ✔
│  │  ├─ repeatedTest() :: repetition 8 of 10 ✔
│  │  ├─ repeatedTest() :: repetition 9 of 10 ✔
│  │  └─ repeatedTest() :: repetition 10 of 10 ✔
│  ├─ repeatedTestWithRepetitionInfo(RepetitionInfo) ✔
│  │  ├─ repeatedTestWithRepetitionInfo(RepetitionInfo) :: repetition 1 of 5 ✔
│  │  ├─ repeatedTestWithRepetitionInfo(RepetitionInfo) :: repetition 2 of 5 ✔
│  │  ├─ repeatedTestWithRepetitionInfo(RepetitionInfo) :: repetition 3 of 5 ✔
│  │  ├─ repeatedTestWithRepetitionInfo(RepetitionInfo) :: repetition 4 of 5 ✔
│  │  └─ repeatedTestWithRepetitionInfo(RepetitionInfo) :: repetition 5 of 5 ✔
│  ├─ Repeat! ✔
│  │  └─ Repeat! 1/1 ✔
