...
| `@CleanupMode`           | Used to control how temporary directories are managed. Cleanup modes of ALWAYS and NEVER can be configured to determine whether a temporary directory is cleaned up or not after a test completes.
|===
