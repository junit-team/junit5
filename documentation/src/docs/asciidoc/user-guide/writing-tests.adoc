...
| `@BeforeParameterizedClassInvocation` | Denotes that the annotated method should be executed once _before_ each invocation of a `@ParameterizedClass`.
| `@AfterParameterizedClassInvocation`  | Denotes that the annotated method should be executed once _after_ each invocation of a `@ParameterizedClass`.
