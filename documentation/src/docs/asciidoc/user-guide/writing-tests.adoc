...
by splitting the display name of the test, in this way making
the results more indicative and easy to read.

the separator between the names of the tests, can optionally
be customized and if this is not declared, by default the separator `", "` and
the generator you want to use by defining value with the class.
