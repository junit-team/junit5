[[writing-tests]]
== Writing Tests
:testDir: /media/data/home/rmannibucau/1_dev/junit5/documentation/src/test/java
...
mecanism but sometimes it is not possible - generally when depending on an external system.
