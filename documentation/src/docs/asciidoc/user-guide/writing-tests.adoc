...
TODO Link to <<extensions, extensions-conditions>>
...
The following names are bound to each script context:
[cols="25,75"]
|===
| Name                          | Description
...
NOTE: An accessor provides access to a map-like structure via a simple
