...
temporary directories are not deleted after a test completes. The default cleanup mode is
ALWAYS. TempDirStrategy annotations may be applied to nested test classes.
