...
Please refer to the
https://docs.gradle.org/current/userguide/java_testing.html#java_testing[official Gradle documentation]
...
sufficient to declare one dependency including a version to be able to omit the version
for all other JUnit artifacts.
...
WARNING: Even though pre-8.0 versions of Gradle don't require declaring an explicit
