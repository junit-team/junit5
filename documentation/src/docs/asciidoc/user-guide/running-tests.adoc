...
====
To avoid interoperability issues, it is recommended to use a recent versions of Maven
Surefire/Failsafe (3.0.0 or later) because it automatically aligns the used version of the
JUnit Platform Launcher with the JUnit Platform version found on the test runtime
classpath.
