...
for executing tests on the JUnit Platform. Thus, the `junit-platform-gradle-plugin` will
be deprecated in JUnit Platform 1.2 and discontinued in version 1.3. Please switch to
Gradle's standard `test` task and `useJUnitPlatform()`.
====
