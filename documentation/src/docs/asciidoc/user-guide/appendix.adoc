...
Artifacts for final releases and milestones are deployed to {Maven_Central}, and
...
* *Artifact IDs*:
  ...
  `junit-platform-console-standalone`::
    An executable JAR with all dependencies included is provided in {Maven_Central} under the
