...
JUnit Jupiter also guarantees _wrapping_ behavior within class hierarchies for
user-supplied lifecycle callbacks such as `@BeforeAll`, `@AfterAll`, `@BeforeEach`, and
`@AfterEach`.
...
The following sequence diagram helps to shed further light on actually what goes on within
