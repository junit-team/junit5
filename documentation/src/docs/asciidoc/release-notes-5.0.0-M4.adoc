...
* An executable `junit-platform-console-{platform-version}-standalone.jar` containing the two
  test engines Jupiter and Vintage with all dependencies is generated. It provides hassle-free
  usage of JUnit 5 in projects that manually manage their dependencies.
