...
** See <<release-notes-5.0.0-m1-migration-artifacts>> and <<index.adoc#dependency-metadata,Dependency Metadata>>.
...
*** See <<index.adoc#running-tests-junit-platform-runner-technical-names,Display Names vs. Technical Names>>.
...
** See <<index.adoc#running-tests-build-gradle,Gradle>> for further details.
...
* <<index.adoc#writing-tests-dynamic-tests,Dynamic Tests>>: tests can now be registered dynamically
