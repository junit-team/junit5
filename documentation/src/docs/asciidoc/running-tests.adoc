...
To use the JUnit Ant plugin, you first need to make sure that you are running Apache
Ant. Once you've done that, you can configure `build.xml` as follows.
...
is in your classpath environment variable similar to the following:
