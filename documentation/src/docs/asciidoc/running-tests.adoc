...
[[running-tests-gradle-junit-enable]]
...
[[running-tests-gradle-junit-configure]]
...
[[running-tests-gradle-engines-configure]]
...
[[running-tests-gradle-junit-using]]
...
[[running-tests-gradle-junit-limitations]]
...
JUnit Jupiter tests and prints test execution results to the console.
...
[[running-tests-console-single-test]]
==== Single Test Class
...
[[running-tests-console-test-suite]]
==== Test Suite
