...
The JUnit 5 team released [Milestone 6](docs/current/user-guide/#release-notes-5.0.0-m6) on July 18, 2017 and is currently working on a release candidate and ultimately a GA release (see [Roadmap](https://github.com/junit-team/junit5/wiki/Roadmap) for details).
