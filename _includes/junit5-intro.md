...
The JUnit 5 team released [Milestone 5](docs/current/user-guide/#release-notes-5.0.0-m5) on July 4, 2017, and is currently working on an additional milestone, a release candidate, and ultimately a GA release (see [Roadmap](https://github.com/junit-team/junit5/wiki/Roadmap) for details).
