...
require(javaVersion.isCompatibleWith(JavaVersion.VERSION_15)) {
	"The JUnit 5 build requires Java 15 or higher. Currently executing with Java ${javaVersion.majorVersion}."
}
