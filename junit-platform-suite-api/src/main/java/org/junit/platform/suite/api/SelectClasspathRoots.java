...
/**
 * {@code @SelectClasspathRoots} specifies the classpath root to
 ...
 * @see Configuration
 * @see org.junit.platform.engine.discovery.DiscoverySelectors#selectClasspathRoots(Set)
 */
...
public @interface SelectClasspathRoots {

	/**
	 * One or more classpath roots to select.
	 */
	String[] value();
