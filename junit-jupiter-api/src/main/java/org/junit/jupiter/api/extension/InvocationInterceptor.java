...
public interface InvocationInterceptor extends Extension {
	...
	default void interceptDynamicContainer(Invocation<Void> invocation,
			DynamicContainerInvocationContext invocationContext, ExtensionContext extensionContext) throws Throwable {
		invocation.proceed();
	}
